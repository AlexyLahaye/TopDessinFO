                ...
                <div>
                    <div className="cardRank uk-card uk-card-body uk-flex">
                        ...
                        <div className="uk-width-2-3 ">
                            ...
                            <h4 className="noRank uk-margin-remove">#450{ranks.length > 0 && ranks[0].classe}</h4>
                ...
                <div>
                    <div className="cardRank uk-card uk-card-body uk-flex">
                        ...
                        <div className="uk-width-2-3 ">
                            ...
                            <h4 className="noRank uk-margin-remove">#122{ranks.length > 0 && ranks[1].classe}</h4>
                ...
                <div>
                    <div className="cardRank uk-card uk-card-body uk-flex">
                        ...
                        <div className="uk-width-2-3 ">
                            ...
                            <h4 className="noRank uk-margin-remove">#321{ranks.length > 0 && ranks[2].classe}</h4>
